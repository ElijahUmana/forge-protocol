...
export async function POST(request: NextRequest) {
  ...
  const response = await anthropic.messages.create({
    ...
    messages: [{
      role: "user",
      content: `You are a security auditor summarizing an autonomous audit. Write a concise, professional summary (3-5 sentences) of this security audit. You may use **bold** for emphasis but do NOT use headings (##) or bullet points.
